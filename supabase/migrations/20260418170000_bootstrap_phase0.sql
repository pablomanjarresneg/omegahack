-- Phase 0 bootstrap: extensions, schemas, roles, storage buckets.
...
comment on schema qa_bank is
  'Isolated Q&A corpus (Phase 6 RAG). Read-only from app_qa_reader; no access from app_operational.';
...
-- used by seed/ingest scripts. Phase 1 will add tenant-scoped policies for
-- attachments; qa-corpus stays service-role-only.
