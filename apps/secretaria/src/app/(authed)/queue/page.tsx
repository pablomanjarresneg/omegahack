...
function TabsBar({ current }: { current: "mine" | "team" }) {
  return (
    <nav
      ...
      className="flex gap-1 border-b border-border bg-surface px-6 py-2 text-xs"
    >
...
function FiltersBar({
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 border-b border-border bg-surface px-6 py-2.5">
      <div className="flex flex-wrap gap-1.5" role="group" aria-label="Filtro por urgencia SLA">
      ...
      <form action="/queue" method="get" className="ml-auto flex items-center gap-2 text-xs">
