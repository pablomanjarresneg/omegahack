      ...
      <div className="relative mx-auto max-w-6xl px-6">
        <div className="mx-auto flex max-w-3xl flex-col items-center text-center">
          ...
          <p className="mt-6 max-w-2xl text-balance text-lg text-muted-foreground md:text-xl">
            CAROL recibe, valida, clasifica y vence los plazos de las peticiones ciudadanas
            de su alcaldía. Cumple Ley 1755/2015 y Ley 1581/2012 por diseño.
          </p>
          ...
          <div className="mt-5 font-mono text-[11px] uppercase tracking-[0.2em] text-muted-foreground">
            <span className="text-primary">CAROL</span> · Control · Automatización · Razonamiento · Organización · Logística
          </div>
        </div>

        <div className="relative mx-auto mt-16 max-w-5xl">
          <div className="absolute -inset-4 rounded-3xl opacity-60 blur-2xl"
            style={{ background: "radial-gradient(60% 60% at 50% 0%, color-mix(in oklab, var(--primary) 25%, transparent), transparent)" }} />
          <DashboardMock />
        </div>
