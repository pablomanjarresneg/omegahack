...
`apps/secretaria` is intentionally not Vercel-linked yet.
...
- GCP e2-micro VM + n8n + Caddy (workflow automation host).
- Sentry + Grafana Cloud project creation (observability wiring).
