          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div>
              ...
              <ul className="mt-3 space-y-1.5 text-sm">
                <li>
                  <Link to="/portal/ayuda" className="text-foreground/80 hover:text-primary">
                    ¿Qué es una PQRSD?
                  </Link>
                </li>
                <li>
...
function NavLink({
  ...
  to: "/portal" | "/portal/radicar" | "/portal/seguimiento" | "/portal/ayuda";
  children: ReactNode;
}) {
  return (
    <Link
      ...
      activeProps={{
        className: "rounded-lg bg-accent px-3 py-2 text-sm font-medium text-foreground",
      }}
      inactiveProps={{
        className:
          "rounded-lg px-3 py-2 text-sm text-muted-foreground hover:bg-accent hover:text-foreground transition-colors",
      }}
    >
      {children}
    </Link>
