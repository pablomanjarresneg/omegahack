...
const INVALID_REASON_MESSAGES: Record<InvalidReasonCode, string> = {
  ...
  anonimo_sin_datos_contacto: 'La solicitud anonima no incluye datos de contacto ni ruta publica de respuesta.',
...
export function deriveInvalidReasons(
  ...
  if (
    ...
    !classification.anonimato.public_response_route
  ) {
